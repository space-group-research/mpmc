...
void checkpoint(system_t *system)
{
    ...
    switch (system->ensemble)
    {
        ...
        case ENSEMBLE_UVT :
            ...
            if (get_rand() < system->insert_probability)
            {    /* do a particle insertion/deletion move */
        ...
        case ENSEMBLE_NPT :
            ...
            { //if volume probability isn't set, then do volume moves with prob = 1/nmolecules
