...
molecule_t *read_molecules(FILE * fp, system_t *system) {
	...
	char token_atom[MAXLINE], token_atomid[MAXLINE], token_atomtype[MAXLINE], token_moleculetype[MAXLINE],
		...
		token_sigma[MAXLINE], token_omega[MAXLINE], token_gwp_alpha[MAXLINE], token_c6[MAXLINE], token_c8[MAXLINE], token_c10[MAXLINE], token_c12[MAXLINE];
	...
	double current_x, current_y, current_z,
		...
		current_c8, current_c10, current_c12; //, current_molecule_mass; (unused variable)
	...
	while(fgets(linebuf,MAXLINE,fp)) {
		...
		sscanf(linebuf, "%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n", 
			...
			token_c6, token_c8, token_c10, token_c12);
